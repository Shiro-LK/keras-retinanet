...
def preprocess_image(x, mean=True, normalize=0):
    ...
    # normalise image. If =1 then normalize between 0 and 1, if -1, normalize between -1 and 1, if 0 no normalization
    if normalize == 1:
        x = x/255.0
    elif normalize == -1:
        x = x/255.0 * 2.0 - 1
